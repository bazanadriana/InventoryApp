...
export default function Home() {
  const { isAuthed, loginGoogle, loginGitHub, logout } = useAuth();
...
function GoogleIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={className}>
      <path fill="#EA4335" d="M12 10.2v3.9h5.5c-.24 1.4-1.66 4.1-5.5 4.1-3.32 0-6.02-2.74-6.02-6.1S8.18 6 11.5 6c1.9 0 3.18.8 3.91 1.47l2.66-2.57C16.8 3.3 14.6 2.4 11.5 2.4 6.37 2.4 2.2 6.55 2.2 11.7S6.37 21 11.5 21c6.65 0 8.06-5.63 7.56-8.6H12Z"/>
      <path fill="#4285F4" d="M21.5 12c0-.65-.06-1.14-.16-1.64H12v3.13h5.39c-.11.82-.73 2.07-2.1 2.91l3.22 2.5C20.2 17.7 21.5 15.1 21.5 12Z"/>
      <path fill="#FBBC05" d="M6.95 14.44a6.05 6.05 0 0 1 0-4.9L3.72 7.04a10.2 10.2 0 0 0 0 9.9l3.23-2.5Z"/>
      <path fill="#34A853" d="M11.5 21c2.9 0 5.33-.96 7.1-2.62l-3.22-2.5c-.86.55-2 1.06-3.88 1.06-2.98 0-5.5-2.03-6.4-4.77l-3.24 2.5C3.63 18.6 7.25 21 11.5 21Z"/>
    </svg>
  );
}
